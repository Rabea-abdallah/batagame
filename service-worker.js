const CACHE_NAME = 'batta-uno-v44';
const ASSETS = [
  './',
  './index.html',
  './lobby.html',
  ...
  './assets/js/network/VoiceClipStore.js',
  './assets/js/network/VoiceAudio.js',
  './assets/js/network/MicrophoneAccess.js',
  './assets/js/network/VoiceRecorder.js',
  './assets/js/network/VoiceService.js',
