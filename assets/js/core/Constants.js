...
export const EVENTS = {
  ...
  // Voice clips (room P2P, no cloud)
  VOICE_CLIP: 'voice:clip',
  VOICE_CLIP_PART: 'voice:clip-part',
  VOICE_FULL_SYNC: 'voice:full-sync',
  VOICE_SYNC_REQUEST: 'voice:sync-request'
};

export const VOICE_MAX_CLIPS_PER_PLAYER = 3;
export const VOICE_MAX_DURATION_MS = 12000;
export const VOICE_MIN_DURATION_MS = 600;
export const VOICE_MAX_BYTES = 350000;
/** Max base64 chars per P2P chunk (WebRTC ~64–256KB message limit). */
export const VOICE_CLIP_CHUNK_B64 = 16000;
